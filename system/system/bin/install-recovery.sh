#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/platform/bootdevice/by-name/recovery:33554432:c4a4f582153690ef9aa07047da785be09f293b87; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/platform/bootdevice/by-name/boot:33554432:7090ffd0f594b38999cb3046a86283dcb2887f57 \
          --target EMMC:/dev/block/platform/bootdevice/by-name/recovery:33554432:c4a4f582153690ef9aa07047da785be09f293b87 && \
